        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {rings.map((ring) => (
            <Card key={ring.id} className="flex flex-col overflow-hidden">
              <div className="relative pt-[100%]"> {/* Cria um contêiner quadrado */}
                <img
              ...
              <CardContent className="flex-grow p-4">
                ...
                <p className="text-sm"><strong>Poder:</strong> {ring.power}</p>
                <p className="text-sm"><strong>Portador:</strong> {ring.bearer}</p>
                <p className="text-sm"><strong>Forjado por:</strong> {ring.forgedBy}</p>
              </CardContent>
