...
const login = async (req, res) => {
    try {
        ...
        res.cookie('LOTR-AUTH', user.authentication.sessionToken, {
            domain: 'localhost',
            path: '/',
            httpOnly: true, // Somente acessível pelo backend
            secure: false, // Se estiver em localhost, use false; em produção use true com HTTPS
            sameSite: 'lax', // Permite cookies de origem cruzada em alguns casos, como navegação entre links
            maxAge: 24 * 60 * 60 * 1000, // Tempo de expiração
        });
